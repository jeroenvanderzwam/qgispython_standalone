...
<qgis simplifyMaxScale="1" simplifyAlgorithm="0" simplifyLocal="1" version="3.10.2-A Coruña" maxScale="0" minScale="5001" simplifyDrawingHints="0" readOnly="0" hasScaleBasedVisibilityFlag="1" styleCategories="AllStyleCategories" labelsEnabled="1" simplifyDrawingTol="1">
  ...
  <renderer-v2 enableorderby="0" forceraster="0" symbollevels="0" attr="fclass" type="categorizedSymbol">
    <categories>
      ...
      <category symbol="1" value="peak" label="peak" render="true"/>
      <category symbol="2" value="spring" label="spring" render="true"/>
      <category symbol="3" value="tree" label="tree" render="true"/>
      <category symbol="4" value="cave_entrance" label="cave_entrance" render="true"/>
      <category symbol="5" value="weir" label="weir" render="true"/>
    ...
    <symbols>
      ...
      <symbol force_rhr="0" alpha="1" name="5" type="marker" clip_to_extent="1">
        <layer enabled="1" locked="0" class="SvgMarker" pass="0">
          ...
          <prop v="0" k="fixedAspectRatio"/>
          <prop v="1" k="horizontal_anchor_point"/>
          <prop v="crosses/Star1.svg" k="name"/>
          <prop v="0,0" k="offset"/>
          <prop v="3x:0,0,0,0,0,0" k="offset_map_unit_scale"/>
          <prop v="MM" k="offset_unit"/>
          <prop v="35,35,35,255" k="outline_color"/>
  ...
  <labeling type="rule-based">
    <rules key="{b65e5ecd-9961-49d9-bdf0-c02638485d4a}">
      <rule key="{1163136c-e287-4b6a-be8b-2a68887d0f09}" filter=" &quot;fclass&quot;  =  'tree' ">
        <settings calloutType="simple">
          <text-style textOpacity="1" useSubstitutions="0" fontCapitals="0" fontWeight="50" fontLetterSpacing="0" fontWordSpacing="0" isExpression="0" fontItalic="0" fontUnderline="0" namedStyle="Standaard" fontSize="6" textColor="80,167,77,255" fontKerning="1" fontStrikeout="0" fieldName="name" previewBkgrdColor="255,255,255,255" fontFamily="Verdana" blendMode="0" textOrientation="horizontal" multilineHeight="1" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontSizeUnit="MapUnit">
            <text-buffer bufferJoinStyle="128" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferColor="255,255,255,255" bufferBlendMode="0" bufferDraw="1" bufferSizeUnits="MapUnit" bufferNoFill="0" bufferSize="0.2" bufferOpacity="0.85"/>
      ...
      <rule key="{7ab21d24-6920-44a1-ae11-6c4d2c9ef46d}" filter=" &quot;fclass&quot;  !=  'tree' ">
        <settings calloutType="simple">
          <text-style textOpacity="1" useSubstitutions="0" fontCapitals="0" fontWeight="50" fontLetterSpacing="0" fontWordSpacing="0" isExpression="0" fontItalic="0" fontUnderline="0" namedStyle="Standaard" fontSize="6" textColor="141,115,82,255" fontKerning="1" fontStrikeout="0" fieldName="name" previewBkgrdColor="255,255,255,255" fontFamily="Verdana" blendMode="0" textOrientation="horizontal" multilineHeight="1" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontSizeUnit="MapUnit">
            <text-buffer bufferJoinStyle="128" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferColor="255,255,255,255" bufferBlendMode="0" bufferDraw="1" bufferSizeUnits="MapUnit" bufferNoFill="1" bufferSize="0.2" bufferOpacity="1"/>
            <background shapeFillColor="255,255,255,255" shapeSVGFile="" shapeSizeUnit="MM" shapeType="0" shapeOffsetUnit="MM" shapeRadiiUnit="MM" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeBorderColor="128,128,128,255" shapeJoinStyle="64" shapeOpacity="1" shapeOffsetY="0" shapeRotation="0" shapeRotationType="0" shapeBorderWidth="0" shapeSizeY="0" shapeSizeX="0" shapeRadiiY="0" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeDraw="0" shapeSizeType="0" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeBorderWidthUnit="MM" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeRadiiX="0" shapeOffsetX="0" shapeBlendMode="0"/>
            <shadow shadowOffsetDist="1" shadowOffsetGlobal="1" shadowColor="0,0,0,255" shadowOffsetMapUnitScale="3x:0,0,0,0,0,0" shadowUnder="0" shadowOffsetUnit="MM" shadowBlendMode="6" shadowDraw="0" shadowRadiusUnit="MM" shadowOpacity="0.7" shadowScale="100" shadowOffsetAngle="135" shadowRadius="1.5" shadowRadiusAlphaOnly="0" shadowRadiusMapUnitScale="3x:0,0,0,0,0,0"/>
            <dd_properties>
              <Option type="Map">
          ...
          <text-format plussign="0" placeDirectionSymbol="0" rightDirectionSymbol=">" formatNumbers="0" multilineAlign="3" autoWrapLength="0" wrapChar="" addDirectionSymbol="0" useMaxLineLengthForAutoWrap="1" reverseDirectionSymbol="0" leftDirectionSymbol="&lt;" decimals="3"/>
          <placement placement="1" geometryGeneratorEnabled="0" centroidInside="0" preserveRotation="1" repeatDistance="0" rotationAngle="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" overrunDistanceUnit="MM" priority="5" offsetType="0" geometryGeneratorType="PointGeometry" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" centroidWhole="0" distMapUnitScale="3x:0,0,0,0,0,0" repeatDistanceUnits="MM" fitInPolygonOnly="0" maxCurvedCharAngleIn="25" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" geometryGenerator="" offsetUnits="MM" dist="0" quadOffset="7" overrunDistance="0" layerType="UnknownGeometry" yOffset="0" placementFlags="10" xOffset="0" distUnits="MM" maxCurvedCharAngleOut="-25"/>
          <rendering fontMaxPixelSize="10000" scaleMax="0" obstacle="1" fontMinPixelSize="3" maxNumLabels="2000" mergeLines="0" displayAll="0" limitNumLabels="0" upsidedownLabels="0" minFeatureSize="0" scaleVisibility="0" obstacleType="0" drawLabels="1" scaleMin="0" obstacleFactor="1" fontLimitPixelSize="0" zIndex="0" labelPerPart="0"/>
          <dd_properties>
            <Option type="Map">
              <Option name="name" value="" type="QString"/>
              <Option name="properties"/>
