...
<qgis simplifyLocal="1" styleCategories="AllStyleCategories" readOnly="0" hasScaleBasedVisibilityFlag="0" simplifyDrawingHints="0" minScale="1e+08" labelsEnabled="1" simplifyDrawingTol="1" simplifyAlgorithm="0" simplifyMaxScale="1" maxScale="0" version="3.10.0-A Coruña">
  <flags>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style fontKerning="1" fontLetterSpacing="0" fontCapitals="0" textOrientation="horizontal" useSubstitutions="0" multilineHeight="1" isExpression="0" fontSizeUnit="MapUnit" textColor="115,103,91,255" namedStyle="Standaard" fieldName="name" textOpacity="1" fontStrikeout="0" fontItalic="0" fontWordSpacing="0" fontFamily="Verdana" fontUnderline="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" previewBkgrdColor="255,255,255,255" fontSize="13" blendMode="0" fontWeight="50">
        <text-buffer bufferDraw="1" bufferBlendMode="0" bufferJoinStyle="128" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferColor="255,255,255,255" bufferOpacity="1" bufferSize="3" bufferSizeUnits="MapUnit" bufferNoFill="0"/>
      ...
      <placement distMapUnitScale="3x:0,0,0,0,0,0" quadOffset="4" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" layerType="PolygonGeometry" distUnits="MM" maxCurvedCharAngleIn="20" centroidInside="0" repeatDistance="0" overrunDistanceUnit="MM" preserveRotation="1" geometryGeneratorType="PointGeometry" centroidWhole="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" offsetUnits="MapUnit" repeatDistanceUnits="MM" geometryGeneratorEnabled="0" rotationAngle="0" priority="5" offsetType="0" fitInPolygonOnly="0" overrunDistance="0" placementFlags="0" placement="1" yOffset="0" xOffset="0" dist="0" geometryGenerator="" maxCurvedCharAngleOut="-20"/>
      <rendering scaleMin="1" fontMinPixelSize="3" maxNumLabels="2000" zIndex="0" minFeatureSize="0" obstacleFactor="1" labelPerPart="0" obstacleType="0" scaleVisibility="1" fontMaxPixelSize="10000" drawLabels="1" displayAll="0" fontLimitPixelSize="0" obstacle="1" limitNumLabels="0" scaleMax="50000" upsidedownLabels="0" mergeLines="0"/>
      <dd_properties>
        <Option type="Map">
          <Option name="name" type="QString" value=""/>
          <Option name="properties"/>
  ...
  <aliases>
    ...
    <alias name="" index="4" field="population"/>
  ...
  <constraints>
    ...
    <constraint constraints="0" exp_strength="0" unique_strength="0" notnull_strength="0" field="population"/>
