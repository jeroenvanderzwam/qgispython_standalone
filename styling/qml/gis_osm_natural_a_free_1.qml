...
<qgis simplifyLocal="1" styleCategories="AllStyleCategories" readOnly="0" hasScaleBasedVisibilityFlag="0" simplifyDrawingHints="1" minScale="1e+08" labelsEnabled="1" simplifyDrawingTol="1" simplifyAlgorithm="0" simplifyMaxScale="1" maxScale="0" version="3.10.0-A Coruña">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" attr="fclass" enableorderby="0" type="categorizedSymbol">
    <categories>
      <category symbol="0" label="cave_entrance" render="true" value="cave_entrance"/>
      <category symbol="1" label="cliff" render="true" value="cliff"/>
      <category symbol="2" label="forest" render="true" value="forest"/>
      <category symbol="3" label="park" render="true" value="park"/>
      <category symbol="4" label="riverbank" render="true" value="riverbank"/>
      <category symbol="5" label="water" render="true" value="water"/>
      <category symbol="6" label="beach" render="true" value="beach"/>
      <category symbol="7" label="not classified" render="true" value=""/>
    </categories>
    <symbols>
      ...
      <symbol name="7" alpha="1" clip_to_extent="1" type="fill" force_rhr="0">
        <layer class="LinePatternFill" locked="0" enabled="1" pass="0">
          ...
          <symbol name="@7@0" alpha="1" clip_to_extent="1" type="line" force_rhr="0">
        ...
        <layer class="LinePatternFill" locked="0" enabled="1" pass="0">
          ...
          <symbol name="@7@1" alpha="1" clip_to_extent="1" type="line" force_rhr="0">
            <layer class="SimpleLine" locked="0" enabled="1" pass="0">
              <prop v="square" k="capstyle"/>
              <prop v="5;2" k="customdash"/>
              <prop v="3x:0,0,0,0,0,0" k="customdash_map_unit_scale"/>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style fontKerning="1" fontLetterSpacing="0" fontCapitals="0" textOrientation="horizontal" useSubstitutions="0" multilineHeight="1" isExpression="1" fontSizeUnit="MapUnit" textColor="141,163,128,255" namedStyle="Standaard" fieldName="CASE WHEN &quot;type&quot;  =  'forest'  THEN  &quot;name&quot;  END" textOpacity="1" fontStrikeout="0" fontItalic="0" fontWordSpacing="0" fontFamily="Verdana" fontUnderline="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" previewBkgrdColor="255,255,255,255" fontSize="10" blendMode="0" fontWeight="50">
        <text-buffer bufferDraw="1" bufferBlendMode="0" bufferJoinStyle="128" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferColor="210,232,197,255" bufferOpacity="0.85" bufferSize="4" bufferSizeUnits="MapUnit" bufferNoFill="0"/>
      ...
      <placement distMapUnitScale="3x:0,0,0,0,0,0" quadOffset="4" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" layerType="PolygonGeometry" distUnits="MM" maxCurvedCharAngleIn="20" centroidInside="0" repeatDistance="0" overrunDistanceUnit="MM" preserveRotation="1" geometryGeneratorType="PointGeometry" centroidWhole="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" offsetUnits="MapUnit" repeatDistanceUnits="MM" geometryGeneratorEnabled="0" rotationAngle="0" priority="3" offsetType="0" fitInPolygonOnly="0" overrunDistance="0" placementFlags="0" placement="0" yOffset="0" xOffset="0" dist="0" geometryGenerator="" maxCurvedCharAngleOut="-20"/>
