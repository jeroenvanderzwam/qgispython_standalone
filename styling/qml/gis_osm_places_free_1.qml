...
<qgis hasScaleBasedVisibilityFlag="1" simplifyDrawingTol="1" styleCategories="AllStyleCategories" simplifyAlgorithm="0" simplifyDrawingHints="0" simplifyLocal="1" minScale="5001" readOnly="0" simplifyMaxScale="1" version="3.10.0-A Coruña" maxScale="0" labelsEnabled="1">
  ...
  <renderer-v2 symbollevels="0" attr="fclass" type="categorizedSymbol" forceraster="0" enableorderby="0">
    <categories>
      <category render="true" value="hamlet" label="hamlet" symbol="0"/>
      <category render="true" value="locality" label="locality" symbol="1"/>
      <category render="true" value="suburb" label="suburb" symbol="2"/>
      <category render="true" value="town" label="town" symbol="3"/>
      <category render="true" value="village" label="village" symbol="4"/>
    </categories>
    <symbols>
      <symbol clip_to_extent="1" type="marker" force_rhr="0" alpha="0" name="0">
        <layer pass="0" enabled="1" class="SimpleMarker" locked="0">
          <prop k="angle" v="0"/>
          <prop k="color" v="213,62,79,255"/>
      ...
      <symbol clip_to_extent="1" type="marker" force_rhr="0" alpha="0" name="1">
        <layer pass="0" enabled="1" class="SimpleMarker" locked="0">
          <prop k="angle" v="0"/>
      ...
      <symbol clip_to_extent="1" type="marker" force_rhr="0" alpha="0" name="2">
        <layer pass="0" enabled="1" class="SimpleMarker" locked="0">
          <prop k="angle" v="0"/>
      ...
      <symbol clip_to_extent="1" type="marker" force_rhr="0" alpha="0" name="3">
        <layer pass="0" enabled="1" class="SimpleMarker" locked="0">
          <prop k="angle" v="0"/>
      ...
      <symbol clip_to_extent="1" type="marker" force_rhr="0" alpha="0" name="4">
        <layer pass="0" enabled="1" class="SimpleMarker" locked="0">
          <prop k="angle" v="0"/>
          <prop k="color" v="50,136,189,255"/>
          <prop k="horizontal_anchor_point" v="1"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="name" v="circle"/>
          <prop k="offset" v="0,0"/>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style fontItalic="0" textOpacity="1" textOrientation="horizontal" fontSizeMapUnitScale="3x:0,0,0,0,0,0" isExpression="0" fontFamily="Verdana" fontCapitals="0" fontWordSpacing="0" namedStyle="Standaard" fontLetterSpacing="0" multilineHeight="1" fontSizeUnit="MapUnit" fieldName="name" fontKerning="1" fontStrikeout="0" useSubstitutions="0" textColor="115,103,91,255" previewBkgrdColor="255,255,255,255" fontSize="13" fontWeight="50" fontUnderline="0" blendMode="0">
        <text-buffer bufferJoinStyle="128" bufferOpacity="1" bufferBlendMode="0" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferSizeUnits="MapUnit" bufferDraw="1" bufferColor="255,255,255,255" bufferNoFill="0" bufferSize="3"/>
      ...
      <placement offsetUnits="MapUnit" repeatDistanceUnits="MM" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" maxCurvedCharAngleOut="-20" dist="0" distMapUnitScale="3x:0,0,0,0,0,0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" layerType="UnknownGeometry" rotationAngle="0" placementFlags="0" centroidInside="0" xOffset="0" repeatDistance="0" overrunDistance="0" distUnits="MM" preserveRotation="1" offsetType="0" geometryGeneratorEnabled="0" quadOffset="4" overrunDistanceUnit="MM" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" placement="1" geometryGenerator="" priority="5" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" centroidWhole="0" yOffset="0" fitInPolygonOnly="0" geometryGeneratorType="PointGeometry" maxCurvedCharAngleIn="20"/>
      <rendering limitNumLabels="0" scaleMax="50000" displayAll="0" fontMaxPixelSize="10000" mergeLines="0" labelPerPart="0" fontMinPixelSize="3" obstacleFactor="1" obstacleType="0" scaleVisibility="1" scaleMin="1" upsidedownLabels="0" zIndex="0" fontLimitPixelSize="0" minFeatureSize="0" obstacle="1" maxNumLabels="2000" drawLabels="1"/>
      <dd_properties>
        <Option type="Map">
          <Option type="QString" value="" name="name"/>
          <Option name="properties"/>
  ...
  <aliases>
    ...
    <alias field="population" index="4" name=""/>
  ...
  <constraints>
    ...
    <constraint exp_strength="0" field="population" notnull_strength="0" unique_strength="0" constraints="0"/>
  ...
  <attributetableconfig sortExpression="" actionWidgetStyle="dropDown" sortOrder="0">
    <columns>
      ...
      <column hidden="0" type="field" width="-1" name="population"/>
