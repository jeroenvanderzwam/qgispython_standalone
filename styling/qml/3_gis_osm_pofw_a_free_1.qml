...
<qgis simplifyMaxScale="1" simplifyAlgorithm="0" simplifyLocal="1" version="3.10.2-A Coruña" maxScale="0" minScale="2001" simplifyDrawingHints="1" readOnly="0" hasScaleBasedVisibilityFlag="1" styleCategories="AllStyleCategories" labelsEnabled="1" simplifyDrawingTol="1">
  <flags>
  ...
  <renderer-v2 enableorderby="0" forceraster="0" symbollevels="0" attr="fclass" type="categorizedSymbol">
    <categories>
      <category symbol="0" value="buddhist" label="buddhist" render="true"/>
      <category symbol="1" label="christian_anglican,christian,christian_catholic,christian_evangelical,christian_lutheran,christian_orthodox,christian_protestant,christian_methodist" render="true">
        ...
        <val value="christian_methodist"/>
      </category>
      <category symbol="2" value="hindu" label="hindu" render="true"/>
      <category symbol="3" value="jewish" label="jewish" render="true"/>
      <category symbol="4" label="muslim,muslim_sunni,muslim_shia" render="true">
        <val value="muslim"/>
        <val value="muslim_sunni"/>
        <val value="muslim_shia"/>
      </category>
      <category symbol="5" value="sikh" label="sikh" render="true"/>
      <category symbol="6" value="" label="not classified" render="true"/>
    </categories>
    <symbols>
      ...
      <symbol force_rhr="0" alpha="1" name="4" type="fill" clip_to_extent="1">
        <layer enabled="1" locked="0" class="CentroidFill" pass="0">
          ...
          <symbol force_rhr="0" alpha="1" name="@4@0" type="marker" clip_to_extent="1">
            <layer enabled="1" locked="0" class="SvgMarker" pass="0">
              <prop v="0" k="angle"/>
              <prop v="0,0,0,255" k="color"/>
              <prop v="0" k="fixedAspectRatio"/>
      ...
      <symbol force_rhr="0" alpha="1" name="5" type="fill" clip_to_extent="1">
        <layer enabled="1" locked="0" class="CentroidFill" pass="0">
          ...
          <symbol force_rhr="0" alpha="1" name="@5@0" type="marker" clip_to_extent="1">
            <layer enabled="1" locked="0" class="SvgMarker" pass="0">
              <prop v="0" k="angle"/>
              <prop v="0,0,0,255" k="color"/>
              <prop v="0" k="fixedAspectRatio"/>
              <prop v="1" k="horizontal_anchor_point"/>
              <prop v="religion/place_of_worship_sikh3.svg" k="name"/>
              <prop v="0,0" k="offset"/>
              <prop v="3x:0,0,0,0,0,0" k="offset_map_unit_scale"/>
              <prop v="MM" k="offset_unit"/>
              <prop v="35,35,35,255" k="outline_color"/>
      ...
      <symbol force_rhr="0" alpha="1" name="6" type="fill" clip_to_extent="1">
        <layer enabled="1" locked="0" class="CentroidFill" pass="0">
          ...
          <symbol force_rhr="0" alpha="1" name="@6@0" type="marker" clip_to_extent="1">
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style textOpacity="1" useSubstitutions="0" fontCapitals="0" fontWeight="50" fontLetterSpacing="0" fontWordSpacing="0" isExpression="0" fontItalic="0" fontUnderline="0" namedStyle="Standaard" fontSize="6" textColor="98,98,98,255" fontKerning="1" fontStrikeout="0" fieldName="name" previewBkgrdColor="255,255,255,255" fontFamily="Verdana" blendMode="0" textOrientation="horizontal" multilineHeight="1" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontSizeUnit="MapUnit">
        <text-buffer bufferJoinStyle="128" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferColor="255,255,255,255" bufferBlendMode="0" bufferDraw="1" bufferSizeUnits="MM" bufferNoFill="0" bufferSize="0.6" bufferOpacity="0.7"/>
      ...
      <text-format plussign="0" placeDirectionSymbol="0" rightDirectionSymbol=">" formatNumbers="0" multilineAlign="1" autoWrapLength="0" wrapChar=" " addDirectionSymbol="0" useMaxLineLengthForAutoWrap="1" reverseDirectionSymbol="0" leftDirectionSymbol="&lt;" decimals="3"/>
      <placement placement="1" geometryGeneratorEnabled="0" centroidInside="0" preserveRotation="1" repeatDistance="0" rotationAngle="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" overrunDistanceUnit="MM" priority="0" offsetType="0" geometryGeneratorType="PointGeometry" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" centroidWhole="0" distMapUnitScale="3x:0,0,0,0,0,0" repeatDistanceUnits="MM" fitInPolygonOnly="0" maxCurvedCharAngleIn="20" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" geometryGenerator="" offsetUnits="MapUnit" dist="0" quadOffset="7" overrunDistance="0" layerType="PolygonGeometry" yOffset="4" placementFlags="0" xOffset="0" distUnits="MM" maxCurvedCharAngleOut="-20"/>
      <rendering fontMaxPixelSize="10000" scaleMax="5000" obstacle="1" fontMinPixelSize="3" maxNumLabels="500" mergeLines="0" displayAll="0" limitNumLabels="0" upsidedownLabels="0" minFeatureSize="8" scaleVisibility="1" obstacleType="0" drawLabels="1" scaleMin="1" obstacleFactor="1" fontLimitPixelSize="0" zIndex="0" labelPerPart="0"/>
      <dd_properties>
        <Option type="Map">
          <Option name="name" value="" type="QString"/>
          <Option name="properties"/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortOrder="1" sortExpression="&quot;fclass&quot;">
    <columns>
