...
<qgis hasScaleBasedVisibilityFlag="0" simplifyDrawingTol="1" styleCategories="AllStyleCategories" simplifyAlgorithm="0" simplifyDrawingHints="0" simplifyLocal="1" minScale="1e+08" readOnly="0" simplifyMaxScale="1" version="3.10.0-A Coruña" maxScale="0" labelsEnabled="1">
  <flags>
  ...
  <renderer-v2 symbollevels="0" attr="fclass" type="categorizedSymbol" forceraster="0" enableorderby="0">
    <categories>
      <category render="true" value="island" label="island" symbol="0"/>
    ...
    <symbols>
      <symbol clip_to_extent="1" type="fill" force_rhr="0" alpha="1" name="0">
        <layer pass="0" enabled="1" class="SimpleFill" locked="0">
          ...
          <prop k="outline_color" v="104,104,104,0"/>
