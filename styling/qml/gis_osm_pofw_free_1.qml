...
<qgis simplifyLocal="1" styleCategories="AllStyleCategories" readOnly="0" hasScaleBasedVisibilityFlag="1" simplifyDrawingHints="0" minScale="2001" labelsEnabled="1" simplifyDrawingTol="1" simplifyAlgorithm="0" simplifyMaxScale="1" maxScale="0" version="3.10.0-A Coruña">
  <flags>
  ...
  <renderer-v2 forceraster="0" symbollevels="0" attr="fclass" enableorderby="0" type="categorizedSymbol">
    <categories>
      ...
      <category symbol="1" label="hindu" render="true" value="hindu"/>
      <category symbol="2" label="jewish" render="true" value="jewish"/>
      <category symbol="3" label="muslim" render="true" value="muslim"/>
      <category symbol="4" label="not classified" render="true" value=""/>
    </categories>
    <symbols>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      ...
      <placement distMapUnitScale="3x:0,0,0,0,0,0" quadOffset="7" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" layerType="PointGeometry" distUnits="MM" maxCurvedCharAngleIn="25" centroidInside="0" repeatDistance="0" overrunDistanceUnit="MM" preserveRotation="1" geometryGeneratorType="PointGeometry" centroidWhole="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" offsetUnits="MM" repeatDistanceUnits="MM" geometryGeneratorEnabled="0" rotationAngle="0" priority="5" offsetType="0" fitInPolygonOnly="0" overrunDistance="0" placementFlags="10" placement="1" yOffset="4" xOffset="0" dist="0" geometryGenerator="" maxCurvedCharAngleOut="-25"/>
  ...
  <attributetableconfig sortExpression="&quot;fclass&quot;" actionWidgetStyle="dropDown" sortOrder="0">
    <columns>
      ...
      <column name="name" width="493" type="field" hidden="0"/>
