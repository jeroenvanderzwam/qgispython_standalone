...
<qgis hasScaleBasedVisibilityFlag="1" simplifyDrawingTol="1" styleCategories="AllStyleCategories" simplifyAlgorithm="0" simplifyDrawingHints="0" simplifyLocal="1" minScale="2001" readOnly="0" simplifyMaxScale="1" version="3.10.0-A Coruña" maxScale="0" labelsEnabled="1">
  <flags>
  ...
  <renderer-v2 symbollevels="0" attr="fclass" type="categorizedSymbol" forceraster="0" enableorderby="0">
    <categories>
      <category render="true" label="christian,christian_catholic,christian_evangelical,christian_protestant" symbol="0">
        <val value="christian"/>
        <val value="christian_catholic"/>
        <val value="christian_evangelical"/>
        <val value="christian_protestant"/>
      </category>
      <category render="true" value="hindu" label="hindu" symbol="1"/>
      <category render="true" value="jewish" label="jewish" symbol="2"/>
      <category render="true" value="muslim" label="muslim" symbol="3"/>
    </categories>
    <symbols>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style fontItalic="0" textOpacity="1" textOrientation="horizontal" fontSizeMapUnitScale="3x:0,0,0,0,0,0" isExpression="0" fontFamily="Verdana" fontCapitals="0" fontWordSpacing="0" namedStyle="Standaard" fontLetterSpacing="0" multilineHeight="1" fontSizeUnit="MapUnit" fieldName="name" fontKerning="1" fontStrikeout="0" useSubstitutions="0" textColor="98,98,98,255" previewBkgrdColor="255,255,255,255" fontSize="6" fontWeight="50" fontUnderline="0" blendMode="0">
        <text-buffer bufferJoinStyle="128" bufferOpacity="1" bufferBlendMode="0" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferSizeUnits="MM" bufferDraw="1" bufferColor="255,255,255,255" bufferNoFill="1" bufferSize="0.6"/>
      ...
      <placement offsetUnits="MM" repeatDistanceUnits="MM" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" maxCurvedCharAngleOut="-25" dist="0" distMapUnitScale="3x:0,0,0,0,0,0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" layerType="PointGeometry" rotationAngle="0" placementFlags="10" centroidInside="0" xOffset="0" repeatDistance="0" overrunDistance="0" distUnits="MM" preserveRotation="1" offsetType="0" geometryGeneratorEnabled="0" quadOffset="7" overrunDistanceUnit="MM" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" placement="1" geometryGenerator="" priority="5" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" centroidWhole="0" yOffset="4" fitInPolygonOnly="0" geometryGeneratorType="PointGeometry" maxCurvedCharAngleIn="25"/>
  ...
  <attributetableconfig sortExpression="&quot;fclass&quot;" actionWidgetStyle="dropDown" sortOrder="0">
    <columns>
      ...
      <column hidden="0" type="field" width="493" name="name"/>
