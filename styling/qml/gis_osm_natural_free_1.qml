...
<qgis simplifyLocal="1" styleCategories="AllStyleCategories" readOnly="0" hasScaleBasedVisibilityFlag="1" simplifyDrawingHints="0" minScale="5001" labelsEnabled="1" simplifyDrawingTol="1" simplifyAlgorithm="0" simplifyMaxScale="1" maxScale="0" version="3.10.0-A Coruña">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" attr="fclass" enableorderby="0" type="categorizedSymbol">
    <categories>
      <category symbol="0" label="beach" render="true" value="beach"/>
      <category symbol="1" label="peak" render="true" value="peak"/>
      <category symbol="2" label="spring" render="true" value="spring"/>
      <category symbol="3" label="tree" render="true" value="tree"/>
      <category symbol="4" label="cave_entrance" render="true" value="cave_entrance"/>
      <category symbol="5" label="not classified" render="true" value=""/>
    </categories>
    <symbols>
      ...
      <symbol name="4" alpha="1" clip_to_extent="1" type="marker" force_rhr="0">
        <layer class="SvgMarker" locked="0" enabled="1" pass="0">
          <prop v="0" k="angle"/>
          <prop v="7,7,6,255" k="color"/>
          <prop v="0" k="fixedAspectRatio"/>
          <prop v="1" k="horizontal_anchor_point"/>
          <prop v="symbol/poi_cave.svg" k="name"/>
          <prop v="0,0" k="offset"/>
          <prop v="3x:0,0,0,0,0,0" k="offset_map_unit_scale"/>
          <prop v="MM" k="offset_unit"/>
  ...
  <labeling type="rule-based">
    <rules key="{0767eae4-618d-4d62-839a-becda2675f59}">
      <rule filter=" &quot;fclass&quot;  =  'tree' " key="{c405f7c8-e132-4204-9294-51b32e8e3180}">
        <settings calloutType="simple">
          <text-style fontKerning="1" fontLetterSpacing="0" fontCapitals="0" textOrientation="horizontal" useSubstitutions="0" multilineHeight="1" isExpression="0" fontSizeUnit="MapUnit" textColor="80,167,77,255" namedStyle="Standaard" fieldName="name" textOpacity="1" fontStrikeout="0" fontItalic="0" fontWordSpacing="0" fontFamily="Verdana" fontUnderline="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" previewBkgrdColor="255,255,255,255" fontSize="6" blendMode="0" fontWeight="50">
            <text-buffer bufferDraw="1" bufferBlendMode="0" bufferJoinStyle="128" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferColor="255,255,255,255" bufferOpacity="0.85" bufferSize="0.2" bufferSizeUnits="MapUnit" bufferNoFill="0"/>
          ...
          <placement distMapUnitScale="3x:0,0,0,0,0,0" quadOffset="7" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" layerType="UnknownGeometry" distUnits="MM" maxCurvedCharAngleIn="20" centroidInside="0" repeatDistance="0" overrunDistanceUnit="MM" preserveRotation="1" geometryGeneratorType="PointGeometry" centroidWhole="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" offsetUnits="MapUnit" repeatDistanceUnits="MM" geometryGeneratorEnabled="0" rotationAngle="0" priority="3" offsetType="0" fitInPolygonOnly="0" overrunDistance="0" placementFlags="0" placement="1" yOffset="0" xOffset="0" dist="0" geometryGenerator="" maxCurvedCharAngleOut="-20"/>
          <rendering scaleMin="1" fontMinPixelSize="3" maxNumLabels="2000" zIndex="0" minFeatureSize="0" obstacleFactor="1" labelPerPart="0" obstacleType="0" scaleVisibility="0" fontMaxPixelSize="10000" drawLabels="1" displayAll="0" fontLimitPixelSize="0" obstacle="1" limitNumLabels="0" scaleMax="10000000" upsidedownLabels="0" mergeLines="0"/>
          <dd_properties>
            <Option type="Map">
              <Option name="name" type="QString" value=""/>
              <Option name="properties"/>
      ...
      <rule filter=" &quot;fclass&quot;  !=  'tree' " key="{ed5f362b-c4a0-4e76-b45a-089cd846ea17}">
        <settings calloutType="simple">
          <text-style fontKerning="1" fontLetterSpacing="0" fontCapitals="0" textOrientation="horizontal" useSubstitutions="0" multilineHeight="1" isExpression="0" fontSizeUnit="MapUnit" textColor="141,115,82,255" namedStyle="Standaard" fieldName="name" textOpacity="1" fontStrikeout="0" fontItalic="0" fontWordSpacing="0" fontFamily="Verdana" fontUnderline="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" previewBkgrdColor="255,255,255,255" fontSize="6" blendMode="0" fontWeight="50">
            <text-buffer bufferDraw="1" bufferBlendMode="0" bufferJoinStyle="128" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferColor="255,255,255,255" bufferOpacity="1" bufferSize="0.2" bufferSizeUnits="MapUnit" bufferNoFill="1"/>
            <background shapeOffsetX="0" shapeSizeType="0" shapeType="0" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeSizeX="0" shapeRadiiY="0" shapeRotationType="0" shapeSizeY="0" shapeRadiiX="0" shapeBorderWidth="0" shapeBorderWidthUnit="MM" shapeOffsetUnit="MM" shapeSVGFile="" shapeOffsetY="0" shapeSizeUnit="MM" shapeRadiiUnit="MM" shapeBorderColor="128,128,128,255" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeOpacity="1" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeBlendMode="0" shapeFillColor="255,255,255,255" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeDraw="0" shapeRotation="0" shapeJoinStyle="64"/>
            <shadow shadowOffsetUnit="MM" shadowRadius="1.5" shadowRadiusUnit="MM" shadowRadiusMapUnitScale="3x:0,0,0,0,0,0" shadowRadiusAlphaOnly="0" shadowBlendMode="6" shadowOffsetGlobal="1" shadowDraw="0" shadowUnder="0" shadowOffsetMapUnitScale="3x:0,0,0,0,0,0" shadowOffsetAngle="135" shadowOffsetDist="1" shadowScale="100" shadowOpacity="0.7" shadowColor="0,0,0,255"/>
            <dd_properties>
              <Option type="Map">
          ...
          <text-format wrapChar="" leftDirectionSymbol="&lt;" autoWrapLength="0" useMaxLineLengthForAutoWrap="1" decimals="3" placeDirectionSymbol="0" plussign="0" rightDirectionSymbol=">" multilineAlign="3" addDirectionSymbol="0" formatNumbers="0" reverseDirectionSymbol="0"/>
          <placement distMapUnitScale="3x:0,0,0,0,0,0" quadOffset="7" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" layerType="UnknownGeometry" distUnits="MM" maxCurvedCharAngleIn="25" centroidInside="0" repeatDistance="0" overrunDistanceUnit="MM" preserveRotation="1" geometryGeneratorType="PointGeometry" centroidWhole="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" offsetUnits="MM" repeatDistanceUnits="MM" geometryGeneratorEnabled="0" rotationAngle="0" priority="5" offsetType="0" fitInPolygonOnly="0" overrunDistance="0" placementFlags="10" placement="1" yOffset="0" xOffset="0" dist="0" geometryGenerator="" maxCurvedCharAngleOut="-25"/>
          <rendering scaleMin="0" fontMinPixelSize="3" maxNumLabels="2000" zIndex="0" minFeatureSize="0" obstacleFactor="1" labelPerPart="0" obstacleType="0" scaleVisibility="0" fontMaxPixelSize="10000" drawLabels="1" displayAll="0" fontLimitPixelSize="0" obstacle="1" limitNumLabels="0" scaleMax="0" upsidedownLabels="0" mergeLines="0"/>
          <dd_properties>
            <Option type="Map">
              <Option name="name" type="QString" value=""/>
              <Option name="properties"/>
