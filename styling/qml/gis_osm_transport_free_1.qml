...
<qgis hasScaleBasedVisibilityFlag="1" simplifyDrawingTol="1" styleCategories="AllStyleCategories" simplifyAlgorithm="0" simplifyDrawingHints="0" simplifyLocal="1" minScale="5001" readOnly="0" simplifyMaxScale="1" version="3.10.0-A Coruña" maxScale="0" labelsEnabled="1">
  ...
  <renderer-v2 symbollevels="0" attr="fclass" type="categorizedSymbol" forceraster="0" enableorderby="0">
    <categories>
      <category render="true" value="bus_station" label="bus_station" symbol="0"/>
      <category render="true" value="bus_stop" label="bus_stop" symbol="1"/>
      <category render="true" value="ferry_terminal" label="ferry_terminal" symbol="2"/>
      <category render="true" label="tram_stop,railway_halt,railway_station" symbol="3">
        <val value="tram_stop"/>
        <val value="railway_halt"/>
        <val value="railway_station"/>
      </category>
      <category render="true" value="taxi" label="taxi" symbol="4"/>
    </categories>
    <symbols>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style fontItalic="0" textOpacity="1" textOrientation="horizontal" fontSizeMapUnitScale="3x:0,0,0,0,0,0" isExpression="0" fontFamily="Verdana" fontCapitals="0" fontWordSpacing="0" namedStyle="Standaard" fontLetterSpacing="0" multilineHeight="1" fontSizeUnit="MapUnit" fieldName="name" fontKerning="1" fontStrikeout="0" useSubstitutions="0" textColor="0,146,218,255" previewBkgrdColor="255,255,255,255" fontSize="2" fontWeight="50" fontUnderline="0" blendMode="0">
