...
<qgis simplifyMaxScale="1" simplifyAlgorithm="0" simplifyLocal="1" version="3.10.2-A Coruña" maxScale="0" minScale="2001" simplifyDrawingHints="0" readOnly="0" hasScaleBasedVisibilityFlag="1" styleCategories="AllStyleCategories" labelsEnabled="1" simplifyDrawingTol="1">
  <flags>
  ...
  <renderer-v2 enableorderby="0" forceraster="0" symbollevels="0" attr="fclass" type="categorizedSymbol">
    <categories>
      <category symbol="0" label="christian,christian_catholic,christian_evangelical,christian_protestant,christian_orthodox,christian_anglican,christian_lutheran" render="true">
        <val value="christian"/>
      ...
      <category symbol="1" value="buddhist" label="buddhist" render="true"/>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style textOpacity="1" useSubstitutions="0" fontCapitals="0" fontWeight="50" fontLetterSpacing="0" fontWordSpacing="0" isExpression="0" fontItalic="0" fontUnderline="0" namedStyle="Standaard" fontSize="6" textColor="98,98,98,255" fontKerning="1" fontStrikeout="0" fieldName="name" previewBkgrdColor="255,255,255,255" fontFamily="Verdana" blendMode="0" textOrientation="horizontal" multilineHeight="1" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontSizeUnit="MapUnit">
        <text-buffer bufferJoinStyle="128" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferColor="255,255,255,255" bufferBlendMode="0" bufferDraw="1" bufferSizeUnits="MM" bufferNoFill="1" bufferSize="0.6" bufferOpacity="1"/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortOrder="0" sortExpression="&quot;fclass&quot;">
    <columns>
      ...
      <column width="493" name="name" hidden="0" type="field"/>
