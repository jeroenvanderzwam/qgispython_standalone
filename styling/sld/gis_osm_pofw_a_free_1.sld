  ...
  <NamedLayer>
    ...
    <UserStyle>
      ...
      <se:FeatureTypeStyle>
        ...
        <se:Rule>
          <se:Name>christian_anglican,christian,christian_catholic,christian_evangelical,christian_lutheran,christian_orthodox,christian_protestant</se:Name>
          <se:Description>
            <se:Title>christian_anglican,christian,christian_catholic,christian_evangelical,christian_lutheran,christian_orthodox,christian_protestant</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:Or>
              <ogc:PropertyIsEqualTo>
        ...
        <se:Rule>
          <se:Name>muslim,muslim_sunni</se:Name>
          <se:Description>
            <se:Title>muslim,muslim_sunni</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:Or>
              <ogc:PropertyIsEqualTo>
