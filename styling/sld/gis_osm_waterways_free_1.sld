...
<StyledLayerDescriptor xmlns="http://www.opengis.net/sld" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:se="http://www.opengis.net/se" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:ogc="http://www.opengis.net/ogc" version="1.1.0" xsi:schemaLocation="http://www.opengis.net/sld http://schemas.opengis.net/sld/1.1.0/StyledLayerDescriptor.xsd">
  <NamedLayer>
    ...
    <UserStyle>
      ...
      <se:FeatureTypeStyle>
        <se:Rule>
          <se:Name>main river</se:Name>
          <se:Description>
            <se:Title>main river</se:Title>
          </se:Description>
          ...
          <se:LineSymbolizer>
            <se:Stroke>
              <se:SvgParameter name="stroke">#b8d9f7</se:SvgParameter>
        ...
        <se:Rule>
          <se:Name>small river</se:Name>
          <se:Description>
            <se:Title>small river</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>fclass</ogc:PropertyName>
        ...
        <se:Rule>
          <se:TextSymbolizer>
            ...
            <se:Fill>
              <se:SvgParameter name="fill">#708597</se:SvgParameter>
            </se:Fill>
